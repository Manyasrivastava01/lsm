...
function SelfLoveMeditation() {
  const [currentVideo, setCurrentVideo] = useState(
    "https://www.youtube.com/embed/itZMM5gCboo?list=PLQiGxGHwiuD1kdxsWKFuhE0rITIXe-7yC"
  ); // Default video
  const [currentVideoIndex, setCurrentVideoIndex] = useState(0); // Track current video index

  const videos = [
    {
      title: "Self-Love Meditation 1",
      url: "https://www.youtube.com/embed/itZMM5gCboo?list=PLQiGxGHwiuD1kdxsWKFuhE0rITIXe-7yC",
    },
    {
      title: "Self-Love Meditation 2",
      url: "https://www.youtube.com/embed/2LzWm2wop4k",
    },
    {
      title: "Self-Love Meditation 3",
      url: "https://www.youtube.com/embed/3bS73KZpFVE",
    },
    {
      title: "Self-Love Meditation 4",
      url: "https://www.youtube.com/embed/4zLfCnGVeL4",
    },
    {
      title: "Self-Love Meditation 5",
...
export default SelfLoveMeditation;
